      ...
      <div className="flex justify-between items-center py-3">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          <button 
            ...
            className="relative group bg-[#0b3352] border-2 border-copper px-8 py-2.5 flex flex-col items-center justify-center transition-all duration-500 hover:bg-gradient-to-tr hover:from-[#0b3352] hover:via-[#11517f] hover:to-[#0b3352] rounded-none shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
          >
            {/* Rivets */}
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="bg-[#08253d]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 flex flex-col gap-6 shadow-2xl mx-2">
              ...
              <button 
                onClick={() => window.open('https://valdesmarisqueria.wokiapp.com/', '_blank')} 
                className="relative group w-full bg-[#0b3352] border-2 border-copper px-6 py-3 flex flex-col items-center justify-center transition-all duration-500 hover:bg-gradient-to-tr hover:from-[#0b3352] hover:via-[#11517f] hover:to-[#0b3352] rounded-none shadow-[0_4px_20px_rgba(0,0,0,0.5)] mt-2"
              >
                {/* Rivets */}
                <div className="absolute top-1.5 left-1.5 w-1 h-1 rounded-full bg-copper shadow-[inset_0_1px_1px_rgba(0,0,0,0.5)]"></div>
                <div className="absolute top-1.5 right-1.5 w-1 h-1 rounded-full bg-copper shadow-[inset_0_1px_1px_rgba(0,0,0,0.5)]"></div>
